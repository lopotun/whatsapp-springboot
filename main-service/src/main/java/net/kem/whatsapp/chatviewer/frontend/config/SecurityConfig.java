package net.kem.whatsapp.chatviewer.frontend.config;
...
import net.kem.whatsapp.chatviewer.frontend.service.CustomUserDetailsService;
import net.kem.whatsapp.chatviewer.frontend.service.OAuth2AuthenticationFailureHandler;
import net.kem.whatsapp.chatviewer.frontend.service.OAuth2AuthenticationSuccessHandler;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(authz -> authz
                .requestMatchers("/", "/home", "/login", "/register", "/css/**", "/js/**",
                        "/images/**", "/h2-console/**", "/actuator/health")
                .permitAll().requestMatchers("/api/public/**").permitAll()
                .requestMatchers("/api/internal/**").permitAll() // Allow internal service
                                                                 // communication
